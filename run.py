...
blue_oldman = "blue_oldman"
ru_girl_v1 = "ru_girl_v1"
...
userAudioPathList = os.listdir(os.path.join("inputs", blue_oldman, "source_audio"))
userVideoPathList = os.listdir(os.path.join("inputs", blue_oldman, "source_video"))
for sourceAudioName in userAudioPathList:
    ...
    inputAudioPath = os.path.join(basePath, "inputs", blue_oldman, "source_audio", sourceAudioName)
    inputVideoPath = os.path.join(basePath, "inputs", blue_oldman, "source_video", sourceVideoName)
